...
class UsersTest(unittest.TestCase):
  ...
  """
    ...
    def test_user_creation_with_no_password(self):
        ...
        user1 = {"fist_name": "Akshay", "email": "akshay@mail.com"}
        res = self.client().post(
            "/api/v1/users/",
            headers={"Content-Type": "application/json"},
    ...
    def test_user_creation_with_no_email(self):
        ...
        user1 = {"first_name": "Akshay", "pasword": "akshay@mail.com"}
        res = self.client().post(
            "/api/v1/users/",
            headers={"Content-Type": "application/json"},
            data=json.dumps(user1),
    ...
    def test_user_login_with_invalid_password(self):
        ...
        user1 = {"password": "akshay", "email": "akshay@mail.com"}
        res = self.client().post(
            "/api/v1/users/",
            headers={"Content-Type": "application/json"},
            data=json.dumps(self.user),
    ...
    def test_user_login_with_invalid_email(self):
        """ User Login Tests with invalid credentials """
        user1 = {"password": "passw0rd!", "email": "olawale1111@mail.com"}
        res = self.client().post(
            "/api/v1/users/",
            headers={"Content-Type": "application/json"},
            data=json.dumps(self.user),
    ...
    def test_user_get_me(self):
        ...
        json_data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(json_data.get("email"), "araa@gmail.com")
        self.assertEqual(json_data.get("first_name"), "Ak")
    ...
    def test_user_update_me(self):
        ...
        json_data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(json_data.get("first_name"), "new name")
